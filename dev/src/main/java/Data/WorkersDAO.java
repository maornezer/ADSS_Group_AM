...
//    }
//
//    public List<Integer> fireWorkers(){
//        try {
//            Connection connection = DB.getConnection();
//            LocalDate today = Chain.getToday();
//            List<Integer> workers = new ArrayList<>();
//            String sql = "SELECT * FROM Workers WHERE year = "+ today.getYear() + " AND month =  " + today.getMonthValue() + " AND day = "+ today.getDayOfMonth() + ";";
//            PreparedStatement preparedStatement = connection.prepareStatement(sql);
//            ResultSet resultSet = preparedStatement.executeQuery();
//
//            while (resultSet.next()){
//                DB.getRolesDAO().delete(resultSet.getInt("id"));
//                workers.add(resultSet.getInt(0));
//            }
//
//            sql = "DELETE FROM Workers WHERE year = "+ today.getYear() + " AND month =  " + today.getMonthValue() + " AND day = "+ today.getDayOfMonth() + ";";
//            preparedStatement = connection.prepareStatement(sql);
//            preparedStatement.execute();
//
//            return workers;
