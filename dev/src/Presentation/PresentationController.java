...
public class PresentationController {
    ...
    public void getItemInOrder(int idOrder) {this.transportController.getDomain().generateOrderReport(idOrder);}
    ...
    public void seeAllTransportByDriver(int id) {transportController.getTransportByIdDriver(id);}
    ...
    public Transport createNewTransport() {return this.transportController.createNewTransport();}
