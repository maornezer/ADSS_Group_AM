...
//    }
    ...
    public void addOrder1() {
        ...
        addOrder1data1.put("year", "2024");
        addOrder1data1.put("month", "08");
        addOrder1data1.put("day", "08");
        addOrder1data1.put("source", "101");
        addOrder1data1.put("destination", "102");
    ...
    {
        boolean b1= tr.getLogistics().checkMatchLicense("1002","1001");
