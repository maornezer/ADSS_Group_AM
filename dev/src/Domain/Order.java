...
//    public Order(int shippingID, ShippingZone s_zone, LocalDate ShippingDate, LocalTime DepartureTime) {
...
//    public Order(int shippingID, ShippingZone s_zone, LocalDate shippingDate, LocalTime departureTime,Driver driver, Truck truck) {
//        setShippingID(shippingID);
//        setZone(s_zone);
//        setShippingDate(shippingDate);
//        setDepartureTime(departureTime);
